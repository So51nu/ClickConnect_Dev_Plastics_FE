...
//   Quote, Award as AwardIcon, Briefcase,
// } from 'lucide-react';
...
//   const milestones = [
//     { year: "2008", title: "Company Founded", description: "Started as a small plastic fabrication workshop" },
//     { year: "2012", title: "First Major Contract", description: "Secured contract with industrial manufacturer" },
//     { year: "2015", title: "Technology Upgrade", description: "Invested in CNC and automated fabrication" },
//     { year: "2018", title: "Expansion", description: "Moved to larger facility with increased capacity" },
//     { year: "2021", title: "Quality Certification", description: "Achieved ISO 9001:2015 certification" },
//     { year: "2023", title: "National Presence", description: "Expanded services to multiple states" }
//   ];
...
//             Precision Plastic <span className="text-gold">Fabrication</span> <br /> Since 2008
//           </h1>
//           <p style={{ fontSize: '18px', marginBottom: '35px', opacity: 0.9, maxWidth: '600px' }}>
//             We are a leading plastic fabrication company with over 15 years of experience in delivering high-quality custom plastic solutions for industries across India.
//           </p>
...
//               Leading Plastic Fabrication Experts
//             </h2>
//             <p style={{ color: COLORS.lightText, lineHeight: "1.7", marginBottom: "30px", fontSize: "18px" }}>
//               Dev  Plastic Company was founded in 2008 with a vision to provide high-quality, precision-engineered plastic solutions for industrial and commercial applications. What started as a small workshop has grown into a nationally recognized fabrication company.
//             </p>
...
//                 <div style={{ fontSize: "3rem", fontWeight: "800", color: COLORS.gold, lineHeight: 1 }}>15+</div>
...
//       {/* COMPANY TIMELINE */}
//       <section style={{ padding: "100px 5%", backgroundColor: COLORS.dark, color: "white" }}>
//         <div style={{ textAlign: "center", marginBottom: "60px" }}>
...
//               </div>
//               <div>
//                 <div style={{ fontWeight: "700", fontSize: "16px" }}>Rahul Sharma</div>
//                 <div style={{ color: COLORS.lightText, fontSize: "14px" }}>Operations Head, Chemical Plant</div>
//               </div>
//             </div>
//           </motion.div>
...
//               </div>
//               <div>
//                 <div style={{ fontWeight: "700", fontSize: "16px" }}>Priya Patel</div>
//                 <div style={{ color: COLORS.lightText, fontSize: "14px" }}>Project Manager, Manufacturing Unit</div>
//               </div>
//             </div>
//           </motion.div>
//         </div>
...
import {
  ...
  Search, Users, Clock, Target, Shield,
  TrendingUp, Globe, Heart, Zap, ChevronRight,
  Quote, Award as AwardIcon, Briefcase, X
} from 'lucide-react';
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "50px", marginBottom: "60px" }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: "none", padding: 0 }}>
                ...
                <li style={{ marginBottom: "12px" }}>
                  <Link to="/products" className="nav-link" style={{ color: "#ccc", textDecoration: "none" }}>Products</Link>
                </li>
                <li style={{ marginBottom: "12px" }}>
                  <Link to="/services" className="nav-link" style={{ color: "#ccc", textDecoration: "none" }}>Services</Link>
                </li>
                <li>
