...
//   Search, CheckCircle, PenTool, Layers,
//   Settings, Truck, Users, Clock, Award, Star,
//   Shield, Factory, Thermometer, Zap, Package,
//   ChevronLeft, ChevronRight, Play, Pause,
//   Quote,Gauge, Wrench, Drill, HardHat
// } from 'lucide-react';
...
//       desc: "Fiber Reinforced Plastic sheets for industrial cladding, partitions and interiors.",
//       features: ["Corrosion resistant", "Lightweight & strong", "Hygienic surface options"],
//       image:"src/images/FRP-Wall-Panels.jpg"
//     },
//     {
//       name: "GRP / FRP Architectural Panels",
//       desc: "Glass / Fiber reinforced panels for facade, cladding and architectural finishes.",
//       features: ["Fire retardant options", "Easy to install", "Custom colors & textures"],
//       // ✅ fixed typo w-800 -> w=800 (nothing removed)
//       image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=800"
//     },
//     {
//       name: "PVC Boards / Clean Room Sheets",
//       desc: "Rigid PVC boards for clean rooms, pharma, food units and utility areas.",
//       features: ["Chemical resistant", "Easy to clean", "Consistent finish"],
...
//       desc: "Impact-resistant sheets for roofing, skylights and partitions.",
//       features: ["Impact resistant", "UV protected", "Thermal insulation"],
...
//           <span style={flexRow}><Phone size={14} color={COLORS.gold} /> +91 9876543210</span>
//         </div>
//         <div style={flexRow}>
...
//           <span style={{ fontSize: '28px', fontWeight: '800', lineHeight: 1 }}>DEV<span className="text-gold">PLASTICS</span></span>
//           <span style={{ fontSize: '9px', letterSpacing: '3px', textTransform: 'uppercase', color: '#888' }}>Fabrication</span>
//         </div>
...
//         style={{ position: "relative", height: "90vh", width: "100%", display: "flex", alignItems: "center", overflow: "hidden" }}
//       >
//         {/* Background Images */}
...
//         }}
//       >
//         We provide professional plastic and FRP fabrication services for
//         industrial and commercial applications. Our approach focuses on
//         material strength, precision manufacturing, and consistent quality.
//       </p>
...
//           <motion.span variants={fadeIn} style={headingSmall}>Our Materials</motion.span>
//           <motion.h2 variants={fadeInUp} style={headingLarge}>Materials We Fabricate</motion.h2>
...
//           <motion.h2 variants={fadeInUp} style={headingLarge}>Fabrication Services</motion.h2>
//         </div>
//         <div style={grid3}>
//           <ServiceCard icon={<PenTool size={36} />} title="Custom Molding" desc="Precision molds for industrial components and custom parts." />
//           <ServiceCard icon={<Layers size={36} />} title="Sheet Fabrication" desc="Cutting, bending, and forming plastic sheets to specifications." />
//           <ServiceCard icon={<Drill size={36} />} title="CNC Machining" desc="Computer-controlled precision machining of plastic components." />
...
//           <ServiceCard icon={<Users size={36} />} title="Turnkey Projects" desc="End-to-end project management from design to installation." />
//         </div>
//       </motion.section>
...
//             <h2 style={{ ...headingLarge, marginBottom: 0 }}>Recent Projects</h2>
//           </div>
//           <motion.button
//             {...hoverSoft}
...
//           <ProjectCard img="src/images/control1.png" title="Control Room Cladding" cat="Soundproof FRP Panels" />
//           <ProjectCard img="https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=800" title="Office Partitions" cat="Matte Finish Panels" />
//           <ProjectCard img="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=800" title="Factory Wall Panels" cat="Corrosion Resistant FRP" />
//         </div>
//       </motion.section>
...
//           >
//             <motion.img
//               src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=500"
...
//               <motion.img
//                 src="https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=500"
...
//         <motion.div
//           {...hoverLift}
//           style={{ backgroundColor: COLORS.accent, color: 'white', padding: '60px', borderRadius: '12px', textAlign: 'center' }}
//         >
...
// // ── REUSABLE COMPONENTS ─────────────────────────────────────────────────────
// const sectionStyle = { padding: "80px 5%", width: "100%" };
...
// // const _SkillBar = ({ title, percentage }: { title: string; percentage: string }) => (
// //   <div>
// //     <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px', fontSize: '14px', fontWeight: '700', color: '#444' }}>
// //       <span>{title}</span><span>{percentage}</span>
// //     </div>
...
// //         style={{ backgroundColor: COLORS.gold, height: '100%', borderRadius: '3px' }}
// //       />
// //     </div>
// //   </div>
// // );
